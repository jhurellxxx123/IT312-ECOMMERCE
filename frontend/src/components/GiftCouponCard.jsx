...
const GiftCouponCard = () => {
    ...
    // Destructure the new 'myCoupon' state
    const { coupon, isCouponApplied, applyCoupon, getMyCoupon, removeCoupon, myCoupon } = useCartStore();

    useEffect(() => {
        getMyCoupon();
    }, [getMyCoupon]);

    // Update input when myCoupon is fetched
    useEffect(() => {
        if (myCoupon) setUserInputCode(myCoupon.code);
    }, [myCoupon]);
    ...
    return (
        ...
        >
            ...
            {/* SECTION 1: The Active/Applied Coupon */}
            ...
            {/* SECTION 2: The User's Available Coupon (Not yet applied) */}
            {myCoupon && (
                <div className='mt-4'>
